...
res_gens = [
    ResGen_1649_1.ResGen_1649_1,
    ResGen_4011_1.ResGen_4011_1,
    ResGen_4016_1.ResGen_4016_1,
    ResGen_4017_84.ResGen_4017_84,
    ResGen_4066_1.ResGen_4066_1,
    ResGen_4074_84.ResGen_4074_84,
...
dataSets = {
    "NF": "driving_cycle_FTP75_highway_no_fault_dataset1_16-01-20.mat",
...
for fiIdx, fi in enumerate(np.array(model.f)[fIdx]):
    for fjIdx, fj in enumerate(np.array(model.f)[fIdx]):
        tcIdx = dc.index(fj)
        C[fiIdx, fjIdx] = np.sum(dx[tcIdx][fiIdx, :][data[fj]["fault_vector"] > 0]) / np.sum(
            data[fj]["fault_vector"] > 0
        )
